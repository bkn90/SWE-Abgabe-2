...
```powershell
   ...
   docker compose exec db bash
      ...
      chown postgres:postgres /var/lib/postgresql/tablespace/plattform_account
...
```powershell
   docker compose exec db bash
      psql --dbname=postgres --username=postgres --file=/sql/create-db-plattform_account.sql
      psql --dbname=plattform_account --username=plattform_account --file=/sql/create-schema-plattform_account.sql
      psql --dbname=plattform_account --username=plattform_account --file=/sql/create-table-plattform_account.sql
      psql --dbname=plattform_account --username=postgres --file=/sql/copy-csv-plattform_account.sql
      exit
    docker compose down
```
